...
public class Usuario implements java.io.Serializable {
	...
	public Usuario(String uid, String name, String email, String country, String description,
			Integer[] idsFavouritesMovies, Integer[] idsFavouritesTvShows, Integer[] idsShowLaterMovies,
			Integer[] idsShowLaterTvShows, Integer[] idsProviders, Integer[] idsTheathreMovies, Integer[] idsTopMovies,
			Integer[] idsTopTvShows, Integer[] idsTopGenres, Double latitude, Double longitude, LocalDate birth_date,
			Integer disntace_preference, Integer age_min_preference, Integer age_max_preference, Boolean public_profile,
			String[] userImages, Integer age, double distance) {
		this.uid = uid;
		this.name = name;
		this.email = email;
